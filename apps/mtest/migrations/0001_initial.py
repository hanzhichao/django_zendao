    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('related_requirement', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(app_label)s_%(class)s_related_requirement', to='mproduct.productrequirement', verbose_name='关联需求')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='创建日期')),
                ('modified', models.DateTimeField(auto_now=True, verbose_name='修改日期')),
                ('type', models.CharField(choices=[('func_test', '功能'), ('perf_test', '性能'), ('conf_test', '配置相关'), ('deploy_test', '安装部署'), ('sec_test', '安全相关'), ('api_test', '接口测试'), ('else', '其他')], default='func_test', max_length=20, verbose_name='项目类型')),
